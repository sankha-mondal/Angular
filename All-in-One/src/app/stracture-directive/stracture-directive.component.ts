...
@Component({
  selector: 'app-stracture-directive',
  templateUrl: './stracture-directive.component.html',
  styleUrls: ['./stracture-directive.component.css']
})
export class StractureDirectiveComponent implements OnInit {
